...
function Home() {
  return (
    <section className="cards-container">
      ...
      <Card link="/workers-app" imgSrc={workersFinderImg} alt="workers-app" label="You can find any types of worker in this section." />
      ...
      <Card link="/vehicle-reservation" imgSrc={vehicleReservationImg} alt="vehicle-reservation" label="Vehicle Reservation" />
    </section>
  );
}
